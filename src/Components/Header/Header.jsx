      ...
      <div className="header-container">
        ...
        <div className="bottom-section">
          ...
          <p>
            ...
            experience. I am working as self employed
             I am React Js Developer
          </p>
          <div className="btn-group">
            <button>Connect with me <img src={assets.arrow} alt="arrow" loading="lazy"/> </button>
            <button>my resume <img src={assets.download} alt="download resume" loading="lazy"/> </button>
          </div>
        </div>
      </div>
    </div>
